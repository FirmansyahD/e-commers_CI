...
<div class="body">
<div class="row">
<h1 class="align-center">Barang</h1>

<a style="margin: 35px;margin-left: 1px;" href="#tambah"

class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-
plus"></span> Tambah</a>
...
<button type="button" class="close" data-dismiss="modal"><span class="btn btn-default">close
</span></button>
